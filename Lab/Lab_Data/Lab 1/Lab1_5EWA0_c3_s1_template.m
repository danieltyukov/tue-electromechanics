%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         
%   Script name:        Lab1_5EWA0_c3_s1_template.m                      
%   Comments:           Template script for Lab 1 question 3.1
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
n = [1, (5:5:40)];                             % rotational speed [rev/s]
omega_m = 2*pi*n;                         % rotational speed [rad/s]
Ia = [0.46, 0.55, 0.66, 0.69, 0.75, 0.82, 0.83, 0.86, 0.9];                            % measured armature current
